...
export function SettingsContent() {
  ...
  return (
    ...
    >
      ...
      <div className="h-[calc(100vh_-_102px)] w-full overflow-x-hidden overflow-y-auto pt-8">
        <div className="mx-auto w-full max-w-4xl px-4">
          {tabContents.map((tabContent) => (
            <TabsContent key={tabContent.id} value={tabContent.id} className="mt-0 space-y-6">
              {tabContent.content}
            </TabsContent>
          ))}
        </div>
