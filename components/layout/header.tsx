...
export function Header({ hasSidebar }: { hasSidebar: boolean }) {
  ...
  return (
    <header className={cn(
      ...
      <div className={cn(
        "relative mx-auto flex h-full max-w-full items-center justify-between pr-2.5",
        hasSidebar 
          ? "pl-2 md:pl-2 md:pr-3 lg:pl-2 lg:pr-3.5" 
          : "pl-4 md:pr-3 md:pl-4"
      )}>
        <div className="flex flex-1 items-center justify-between">
          <div className={cn(
            "flex flex-1 items-center",
            hasSidebar && "md:-ml-0.5"
          )}>
