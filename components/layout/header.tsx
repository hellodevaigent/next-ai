    ...
    <header className="h-[50px] border-border pointer-events-none sticky top-0 right-0 left-0 z-50 border-b md:border-none">
      <div className="relative mx-auto flex h-full max-w-full items-center justify-between pr-2.5 pl-2 md:pr-3 md:pl-2 lg:pr-3.5 lg:pl-2">
        <div className="flex flex-1 items-center justify-between">
          <div className="flex flex-1 items-center md:-ml-0.5">
            {isMobile && (
              <button
                type="button"
                onClick={() => toggleSidebar()}
                className="pointer-events-auto text-muted-foreground hover:text-foreground hover:bg-muted inline-flex items-center justify-center rounded-md bg-transparent p-2 transition-colors focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
              >
