...
//       mainLayout.setAttribute('data-vaul-drawer-wrapper', '')
//     } else if (!isOpen && mainLayout) {
//       mainLayout.removeAttribute('data-vaul-drawer-wrapper')
//     }

//     // Cleanup function untuk memastikan attribute dihapus saat component unmount
//     return () => {
//       if (mainLayout) {
//         mainLayout.removeAttribute('data-vaul-drawer-wrapper')
//       }
...
//           <DrawerTitle>History Chats</DrawerTitle>
//           <DrawerDescription>View your previous chats here.</DrawerDescription>
//         </DrawerHeader>
